...
<header class="bg-transparent absolute top-0 left-0 w-full flex items-center z-10">
    <div class="container">
        <div class="flex items-center justify-between relative">
            <div class="px-4">
                <a href="#home" class="font-bold text-3xl text-primary block py-6"><span class="text-dark">Mail</span> Serv!s</a>
            </div>
                    ...
                    <ul class="block lg:flex">
                        ...
                        <li class="group">
                            <a href="#layanan-perbaikan"
                                class="text-base text-dark py-2 mx-8 flex group-hover:text-primary">Layanan Perbaikan</a>
                        </li>
                    </ul>
                </nav>
            </div>
